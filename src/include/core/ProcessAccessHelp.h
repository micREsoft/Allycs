...
public:
	...
	static HANDLE AllycsOpenProcess(DWORD dwDesiredAccess, DWORD dwProcessId);
    ...
    static SIZE_T getSizeOfImageProcessAllycs( HANDLE processHandle, DWORD_PTR moduleBase );
};
