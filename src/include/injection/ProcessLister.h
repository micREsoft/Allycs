...
public:
	...
	ProcessLister()
	{
		...
		_IsWow64Process = reinterpret_cast<def_IsWow64Process>(GetProcAddress(GetModuleHandle(L"kernel32.dll"), "IsWow64Process"));
	}
	~ProcessLister()
	{
...
private:
    ...
    void handleProcessInformationAndAddToList(PSYSTEM_PROCESS_INFORMATION_ALLYCS pProcess);
